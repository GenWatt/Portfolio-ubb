...
export default function SideNav() {
    ...
    const activeColor = (path: string) => loaction.pathname === path ? theme.palette.primary.main : theme.palette.primary.light;
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography color={theme.palette.primary.main} variant="h5" noWrap component="div">
